...
| **Phase 3A Production Pipeline Integration Framework** (`production-os/Fracture_Protocol_Phase3A_Content_Production_Pipeline_Integration_Framework_v1.0.md`) | Integration/navigation/cross-reference layer only: maps end-to-end stage handoffs, department responsibility, and routing across Studio OS, Production OS, Production Bible, Art Bible, and Brand Bible. Holds no ownership over any of them, over canon, or over any other process document — same non-authoritative standing as the Studio Wiki, scoped specifically to the production pipeline rather than the whole repository. |
...
`[v1.2 — 2026-07-14] Added a Document Authority Hierarchy row (Section 3) for the newly-Locked `production-os/Fracture_Protocol_Phase3A_Content_Production_Pipeline_Integration_Framework_v1.0.md`, per "Founder Decision Resolution — Phase 3A Production Standard Promotion," Decision 2. Scope assigned: integration/navigation/cross-reference layer only, non-authoritative over the five documents it routes between, same standing as the Studio Wiki but scoped to the production pipeline. No existing row's scope was changed; no jurisdiction was reassigned.`
