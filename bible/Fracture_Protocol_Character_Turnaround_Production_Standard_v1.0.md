...
**Cross-reference (appended 2026-07-20):** the specific, reusable prompt language that turns each named view above into producible prompt text is defined in `Fracture_Protocol_Turnaround_View_Modifier_Standard_v1.0.md`, established per "Founder Directive — Turnaround View Modifier Standard" after the framing gap this document left open was surfaced during FPP-CHAR-002 preparation. That standard is this document's direct execution-layer companion; nothing above is altered by it.
...
`[v1.1 — 2026-07-20] Cross-reference appended per "Founder Directive — Turnaround View Modifier Standard," pointing Step 2 (Deliverable Layout) to the new `Fracture_Protocol_Turnaround_View_Modifier_Standard_v1.0.md`, which defines the reusable prompt language for each named view. No existing content altered.`
