...
**Age at Story Beginning:** Not previously compiled anywhere in canon. **Proposed (still unconfirmed):** late 30s to early 40s — old enough to have held a senior USCN directorship, worked alongside the Guardian on civilization-scale evaluation, been radicalized by the Sol Collapse, and built the Doctrine into a functioning movement before the story begins, while remaining a contemporary generation above Kael (19) rather than an elder statesman. *Note: the "Cassian Final Alignment Patch" status checklist marks "Age Alignment" as complete, but the patch itself supplies no age or age range — this field still reflects only my own proposed figure from v1.2, not a Founder-confirmed one. Flagged rather than silently marked resolved; needs an explicit number or range, or explicit confirmation of the proposed range above.*
...
⚠️ Age at story beginning (proposed range only, still unconfirmed — see "Not Applied," below)
...
🟢 Legacy Framework Complete — **resolved 2026-07-13, see "Not Applied," below.**

---

### Not Applied — Flagged Rather Than Silently Accepted

**One item held from earlier passes, now resolved:**

- **Legacy Framework, Section 6 of the original submission ("Cassian does not inherit a legacy. He constructs one."):** Held since 2026-07-13 for directly contradicting the Character Bible's "Legacy Framework" (v1.9) — *"Cassian — a person who inherited influence and chose control. His legacy is imposed"* — and the long-established "Contrast with Kael" text. The standing recommendation was to keep the "inherited, then imposed" framing. **Resolved 2026-07-13 via "Founder Directive — Phase 1C Final Certification Patch 1," Required Patch C:** the Founder confirmed and formalized this exact reading into a three-step framework — *"Inherited Legacy → Chose to Reshape It → Imposed It Upon Civilization"* — matching, not overriding, the standing recommendation. Character Bible's "Legacy Framework" section updated to the finalized three-step wording. No longer an open item.

**One item still open, unrelated to Patch 1 (which did not address it):**

- **Age at Story Beginning:** the "Cassian Final Alignment Patch" checklist marked "Age Alignment" ✅ without supplying an age or range. The value in Section 1 remains my own v1.2 proposal (late 30s–early 40s), not a Founder-confirmed figure. Still needs either a specific number/range or explicit confirmation that the proposed range stands.

**Resolved by the "Cassian Final Alignment Patch" (2026-07-13):** Current Location / Doctrine operational base (the Ascendant Network, no single capital, plus the Ascendant Core); Cassian & Night Haven relationship (opposition without contempt, Locked per submission). Both now compiled in full in Section 3 and cross-referenced into the Faction Bible (v1.4).
